...
import congressGlb from "@src/assets/congresso-v2.glb?url";
import congressBaked from "@src/assets/congresso-baked.jpg?url";
...
export default function Model(): JSX.Element {
  // @ts-ignore
  const { nodes } = useGLTF(congressGlb);

  const bakedTexture = useTexture(congressBaked);
