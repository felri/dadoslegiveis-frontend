export default {
  ...
  ptBR: {
    ...
    treemap: {
      description:
        "O gráfico usa tamanhos e cores diferentes para representar as categorias e a quantidade de dinheiro gasto em cada categoria. Esta página fornece uma representação visual das despesas, tornando fácil entender a distribuição de gastos em diferentes categorias.",
    },
    circular_packing: {
      description:
